...
export const sections: Array<{ id: string; heading: string }> = [
  ...
  { id: "Step_and_note_model", heading: "Step and note model" },
...
export const flStudio: ArticleModule = {
  ...
  body: (
    <>
      ...
      <Section heading="Step and note model">
        <P>
          Architecturally, the step grid and the piano roll
          edit the same list. A Channel Rack step is a Note of length zero{" "}
          at a quantized tick. Opening the piano roll on a drum channel
          shows the steps as notes, since each step is already stored as a note.
        </P>
      </Section>
