...
function drawOneFighter(
  ...
  // Proportional to the fighter, not to the screen — see `rimWidthFor`, which
  // the animation lab calls too so the two cannot drift apart.
  const rimWidth = rimWidthFor(rig.scale, cam.zoom);
